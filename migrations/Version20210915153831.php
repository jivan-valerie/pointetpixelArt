 ...
 */
final class Version20210915153831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE images ADD user_id INT NOT NULL, ADD image VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE images DROP user_id, DROP image');
    }
}
